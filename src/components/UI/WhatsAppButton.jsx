...
/**
 * WhatsAppButton
 * Floating "Chat with us" contact button — mirrors the Hubtown homepage CTA.
 * Opens a WhatsApp chat in a new tab. Replace the number with the real one.
 */
const PHONE = '910000000000' // placeholder — set the real WhatsApp number here
const MESSAGE = encodeURIComponent('Hi, I would like to know more about your projects.')

export default function WhatsAppButton() {
  return (
    <a
      className={`${styles.button} fade-in-ui`}
